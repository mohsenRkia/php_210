                        ...
                        <div id="sample_1_wrapper" class="dataTables_wrapper form-inline" role="grid">
                            <table class="table table-striped border-top dataTable" id="sample_1" aria-describedby="sample_1_info">
                                ...
                                <tr role="row">
                                    ...
                                    <th class="hidden-phone sorting" role="columnheader" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" style="width: 212px;">تاریخ ثبت</th>
                                ...
                                @foreach($orders as $order)
                                    <tr class="gradeX odd">
                                        ...
                                        <td class="hidden-phone">{{$order->created_at}}</td>
